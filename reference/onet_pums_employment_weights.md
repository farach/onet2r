...
Converts American Community Survey (ACS), Current Population Survey
(CPS), or similar microdata with occupation codes into SOC-level
employment weights. Use this after downloading PUMS data with packages
such as `tidycensus` or `ipumsr`.
