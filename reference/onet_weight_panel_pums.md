...
The `year` argument means the 1-year ACS PUMS data year. 5-year PUMS
files pool responses across vintages and can mix SOCP code versions
within one file; SOC-vintage labeling is not reliable for them. Prefer
1-year files for weight panels, or resolve codes explicitly with a
crosswalk.
