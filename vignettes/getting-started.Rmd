...
To see which detail sections are available for an occupation:

```{r}
details <- onet_occupation_details("15-1252.00")

# This includes links to detail sections such as skills and tasks
...
occupation_cols <- onet_table_info("occupation_data")
occupation_cols
```
...
#> <U+2139> Set your API key with `Sys.setenv(ONET_API_KEY = "your-key")`
#> <U+2139> Get a key at <https://services.onetcenter.org/developer/>
```
...
#> <U+2139> Expected format: XX-XXXX or XX-XXXX.XX (e.g., 15-1252 or 15-1252.00)
```
...
results
#> # A tibble: 0 <U+00D7> 2
#> # <U+2139> 2 variables: code <chr>, title <chr>
...
#> <U+2716> Invalid table identifier
#> <U+2139> Use onet_tables() to see available tables
```
