...
how much the headline number moves when non-substantive choices change. A result
that only survives one specific set of choices is not a finding. It is a
coincidence with good lighting.
