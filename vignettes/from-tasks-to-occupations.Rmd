...
analysis needs one score per occupation, which means someone has to do the
unglamorous work of weighting and averaging tasks. `onet_task_to_occupation()`
performs that mechanical rollup using O&#42;NET task ratings, and never once
complains about it.
