...
- For broad package validation, run `Rscript tools\validate-clean-install.R --rounds=2` and only enable live checks explicitly with `--live-api` or `--live-archives`.
