...
#' The returned path is the shared cache location and can be replaced by a later
#' forced download. [onet_archive_read()] parses a private verified snapshot
#' rather than this mutable path.
#' @export
#'
#' @examples
#' if (interactive()) {
