...
- Read
  [`vignette("longitudinal-onet-background", package = "onet2r")`](https://farach.github.io/onet2r/dev/articles/longitudinal-onet-background.md)
  before interpreting cross-release changes.
- Read
  [`vignette("longitudinal-archives", package = "onet2r")`](https://farach.github.io/onet2r/dev/articles/longitudinal-archives.md)
  to assemble and reconcile archive panels.
- Read
  [`vignette("oews-wage-context", package = "onet2r")`](https://farach.github.io/onet2r/dev/articles/oews-wage-context.md)
  to choose and apply employment weights.
- Read
  [`vignette("stress-testing-exposure-measure", package = "onet2r")`](https://farach.github.io/onet2r/dev/articles/stress-testing-exposure-measure.md)
